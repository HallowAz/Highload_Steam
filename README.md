...
В Китае Steam имеет отдельный филиал, к тому же Китай находится в центре Восточной Азии. Китай позволяет другим странам скачивать данные с их сайтов, но не разрешает своим гражданам пользоваться серверами других стран. Поэтому было решено разместить 4 датацентра в следующих городах Китая:
...
Дополнительно расположим сервера в:
...
Оставшийся трафик занимает лишь 5% от основного, однако требует низкой задержки. Поэтому выделим датацентры в следующих городах:
